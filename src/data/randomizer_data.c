...
const u8 sRandoSpringBallGfx[384] = INCBIN_U8("data_rando/animated_gfx/spring_ball.gfx");
const u8 sRandoWallJumpGfx[384] = INCBIN_U8("data_rando/animated_gfx/hi_jump.gfx"); // TODO: Unique graphics
const u8 sRandoInfBombJumpGfx[384] = INCBIN_U8("data_rando/animated_gfx/bombs.gfx"); // TODO: Unique graphics
...
enum Bg1BreakableBlock {
    BG1_SHOT_REFORM_BLOCK = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_SHOT_BLOCK_REFORM,
    BG1_BOMB_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_BOMB_BLOCK_REFORM,
    BG1_SPEED_BOOST_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_SPEEDBOOST_REFORM,
    BG1_CRUMBLE = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_CRUMBLE,
    BG1_SLOW_CRUMBLE = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_SLOW_CRUMBLE,
    BG1_MISSILE_NEVER_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_MISSILE_NEVER_REFORM,
    BG1_MISSILE_NO_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_MISSILE_NO_REFORM,
    BG1_SUPER_MISSILE_NEVER_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_SUPER_MISSILE_NEVER_REFORM,
    BG1_SUPER_MISSILE_NO_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_SUPER_MISSILE_NO_REFORM,
    BG1_POWER_BOMB_NEVER_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_POWER_BOMB_NEVER_REFORM,
    BG1_SCREW_ATTACK_NO_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_SCREW_ATTACK_NO_REFORM,
    BG1_SPEED_BOOST_NO_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_SPEEDBOOST_NO_REFORM,
    BG1_BOMB_NEVER_REFORM = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_BOMB_NEVER_REFORM,
    BG1_VERTICAL_BOMB_CHAIN_1 = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_VERTICAL_BOMB_CHAIN1,
    BG1_VERTICAL_BOMB_CHAIN_2 = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_VERTICAL_BOMB_CHAIN2,
    BG1_VERTICAL_BOMB_CHAIN_3 = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_VERTICAL_BOMB_CHAIN3,
    BG1_VERTICAL_BOMB_CHAIN_4 = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_VERTICAL_BOMB_CHAIN4,
    BG1_HORIZONTAL_BOMB_CHAIN_1 = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_HORIZONTAL_BOMB_CHAIN1,
    BG1_HORIZONTAL_BOMB_CHAIN_2 = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_HORIZONTAL_BOMB_CHAIN2,
    BG1_HORIZONTAL_BOMB_CHAIN_3 = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_HORIZONTAL_BOMB_CHAIN3,
    BG1_HORIZONTAL_BOMB_CHAIN_4 = CLIPDATA_TILEMAP_FLAG | CLIPDATA_TILEMAP_HORIZONTAL_BOMB_CHAIN4,
    BG1_HIDDEN_TANK = CLIPDATA_TILEMAP_FLAG | 0x4F,
};

const u16 sBreakableBlockBg1[CLIPDATA_COUNT] = {
    [CLIPDATA_TOP_LEFT_SHOT_BLOCK_NEVER_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_TOP_RIGHT_SHOT_BLOCK_NEVER_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_SHOT_BLOCK_NEVER_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_TOP_LEFT_SHOT_BLOCK_NO_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_TOP_RIGHT_SHOT_BLOCK_NO_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_SHOT_BLOCK_NO_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_CRUMBLE] = BG1_CRUMBLE,
    [CLIPDATA_BOMB_BLOCK_NEVER_REFORM] = BG1_BOMB_NEVER_REFORM,
    [CLIPDATA_MISSILE_BLOCK_NEVER_REFORM] = BG1_MISSILE_NEVER_REFORM,
    [CLIPDATA_SUPER_MISSILE_BLOCK_NEVER_REFORM] = BG1_SUPER_MISSILE_NEVER_REFORM,
    [CLIPDATA_SPEEDBOOST_BLOCK_NO_REFORM] = BG1_SPEED_BOOST_NO_REFORM,
    [CLIPDATA_POWER_BOMB_BLOCK_NEVER_REFORM] = BG1_POWER_BOMB_NEVER_REFORM,
    [CLIPDATA_BOTTOM_LEFT_SHOT_BLOCK_NEVER_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_BOTTOM_RIGHT_SHOT_BLOCK_NEVER_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_SHOT_BLOCK_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_BOTTOM_LEFT_SHOT_BLOCK_NO_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_BOTTOM_RIGHT_SHOT_BLOCK_NO_REFORM] = BG1_SHOT_REFORM_BLOCK,
    [CLIPDATA_SLOW_CRUMBLE] = BG1_SLOW_CRUMBLE,
    [CLIPDATA_BOMB_BLOCK_REFORM] = BG1_BOMB_REFORM,
    [CLIPDATA_MISSILE_BLOCK_NO_REFORM] = BG1_MISSILE_NO_REFORM,
    [CLIPDATA_SUPER_MISSILE_BLOCK_NO_REFORM] = BG1_SUPER_MISSILE_NO_REFORM,
    [CLIPDATA_SPEEDBOOST_BLOCK_REFORM] = BG1_SPEED_BOOST_REFORM,
    [CLIPDATA_SCREW_ATTACK_NO_REFORM] = BG1_SCREW_ATTACK_NO_REFORM,
    [CLIPDATA_HIDDEN_ENERGY_TANK] = BG1_HIDDEN_TANK,
    [CLIPDATA_HIDDEN_MISSILE_TANK] = BG1_HIDDEN_TANK,
    [CLIPDATA_HIDDEN_SUPER_MISSILE_TANK] = BG1_HIDDEN_TANK,
    [CLIPDATA_HIDDEN_POWER_BOMB_TANK] = BG1_HIDDEN_TANK,
    [CLIPDATA_VERTICAL_BOMB_CHAIN1] = BG1_VERTICAL_BOMB_CHAIN_1,
    [CLIPDATA_VERTICAL_BOMB_CHAIN2] = BG1_VERTICAL_BOMB_CHAIN_2,
    [CLIPDATA_VERTICAL_BOMB_CHAIN3] = BG1_VERTICAL_BOMB_CHAIN_3,
    [CLIPDATA_VERTICAL_BOMB_CHAIN4] = BG1_VERTICAL_BOMB_CHAIN_4,
    [CLIPDATA_HORIZONTAL_BOMB_CHAIN1] = BG1_HORIZONTAL_BOMB_CHAIN_1,
    [CLIPDATA_HORIZONTAL_BOMB_CHAIN2] = BG1_HORIZONTAL_BOMB_CHAIN_2,
    [CLIPDATA_HORIZONTAL_BOMB_CHAIN3] = BG1_HORIZONTAL_BOMB_CHAIN_3,
    [CLIPDATA_HORIZONTAL_BOMB_CHAIN4] = BG1_HORIZONTAL_BOMB_CHAIN_4,
};
...
const boolu8 sRandoRevealBreakableBlocks = FALSE;
