...
const struct AnimatedGraphicsData sAnimatedGraphicsEntries[ANIMATED_GFX_ID_COUNT] = {
    ...
    [ANIMATED_GFX_ID_SPRING_BALL] = RANDO_ANIM_GFX(sRandoSpringBallGfx),
    [ANIMATED_GFX_ID_WALL_JUMP] = RANDO_ANIM_GFX(sRandoWallJumpGfx),
    [ANIMATED_GFX_ID_INF_BOMB_JUMP] = RANDO_ANIM_GFX(sRandoInfBombJumpGfx),
