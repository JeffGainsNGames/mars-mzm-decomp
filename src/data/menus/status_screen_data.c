...
#ifdef RANDOMIZER
const u8 sPauseDebug_Event5D_Text[32] = SHIFT_JIS("END                         ");
// New events
const u8 sPauseDebug_Event5C_Text[32] = SHIFT_JIS("GOT SCREW ATTACK HINT       ");
const u8 sPauseDebug_Event5B_Text[32] = SHIFT_JIS("GOT WAVE BEAM HINT          ");
const u8 sPauseDebug_Event5A_Text[32] = SHIFT_JIS("GOT VARIA SUIT HINT         ");
const u8 sPauseDebug_Event59_Text[32] = SHIFT_JIS("GOT HI-JUMP HINT            ");
const u8 sPauseDebug_Event58_Text[32] = SHIFT_JIS("GOT SPEED BOOSTER HINT      ");
const u8 sPauseDebug_Event57_Text[32] = SHIFT_JIS("GOT ICE BEAM HINT           ");
const u8 sPauseDebug_Event56_Text[32] = SHIFT_JIS("GOT BOMBS HINT              ");
const u8 sPauseDebug_Event55_Text[32] = SHIFT_JIS("GOT LONG BEAM HINT          ");
const u8 sPauseDebug_Event54_Text[32] = SHIFT_JIS("ZIPLINES SOURCE             ");
const u8 sPauseDebug_Event53_Text[32] = SHIFT_JIS("LOCATION SPEED BOOSTER      ");
const u8 sPauseDebug_Event52_Text[32] = SHIFT_JIS("LOCATION MORPH BALL         ");
const u8 sPauseDebug_Event51_Text[32] = SHIFT_JIS("LOCATION BOMBS              ");
const u8 sPauseDebug_Event50_Text[32] = SHIFT_JIS("LOCATION WAVE BEAM          ");
const u8 sPauseDebug_Event4F_Text[32] = SHIFT_JIS("LOCATION ICE BEAM           ");
const u8 sPauseDebug_Event4E_Text[32] = SHIFT_JIS("LOCATION LONG BEAM          ");
// Existing events
const u8 sPauseDebug_Event4D_Text[32] = SHIFT_JIS("[UNKNOWN]                   ");
const u8 sPauseDebug_Event4C_Text[32] = SHIFT_JIS("[UNKNOWN]                   ");
const u8 sPauseDebug_Event4B_Text[32] = SHIFT_JIS("ESCAPED CHOZODIA            ");
const u8 sPauseDebug_Event4A_Text[32] = SHIFT_JIS("MECHA RIDLEY KILLED         ");
const u8 sPauseDebug_Event49_Text[32] = SHIFT_JIS("GLASS TUBE BROKEN           ");
const u8 sPauseDebug_Event48_Text[32] = SHIFT_JIS("SPACE PIRATE WITH PB 2      ");
const u8 sPauseDebug_Event47_Text[32] = SHIFT_JIS("SPACE PIRATE WITH PB 1      ");
const u8 sPauseDebug_Event46_Text[32] = SHIFT_JIS("POWER BOMB STOLEN           ");
const u8 sPauseDebug_Event45_Text[32] = SHIFT_JIS("[UNKNOWN]                   ");
const u8 sPauseDebug_Event44_Text[32] = SHIFT_JIS("SKIPPED VARIA SUIT          ");
const u8 sPauseDebug_Event43_Text[32] = SHIFT_JIS("FULLY POWERED SUIT          ");
const u8 sPauseDebug_Event42_Text[32] = SHIFT_JIS("-- MOTHER SHIP EVENTS --    ");
const u8 sPauseDebug_Event41_Text[32] = SHIFT_JIS("ESCAPED ZEBES               ");
const u8 sPauseDebug_Event40_Text[32] = SHIFT_JIS("ZEBETITE 4 DESTROYED        ");
const u8 sPauseDebug_Event3F_Text[32] = SHIFT_JIS("ZEBETITE 3 DESTROYED        ");
const u8 sPauseDebug_Event3E_Text[32] = SHIFT_JIS("ZEBETITE 2 DESTROYED        ");
const u8 sPauseDebug_Event3D_Text[32] = SHIFT_JIS("ZEBETITE 1 DESTROYED        ");
const u8 sPauseDebug_Event3C_Text[32] = SHIFT_JIS("4TH METROID ROOM CLEARED    ");
const u8 sPauseDebug_Event3B_Text[32] = SHIFT_JIS("6TH METROID ROOM CLEARED    ");
const u8 sPauseDebug_Event3A_Text[32] = SHIFT_JIS("2ND METROID ROOM CLEARED    ");
const u8 sPauseDebug_Event39_Text[32] = SHIFT_JIS("5TH METROID ROOM CLEARED    ");
const u8 sPauseDebug_Event38_Text[32] = SHIFT_JIS("3RD METROID ROOM CLEARED    ");
const u8 sPauseDebug_Event37_Text[32] = SHIFT_JIS("1ST METROID ROOM CLEARED    ");
const u8 sPauseDebug_Event36_Text[32] = SHIFT_JIS("RIDLEY STATUE OPENED        ");
const u8 sPauseDebug_Event35_Text[32] = SHIFT_JIS("KRAID STATUE OPENED         ");
const u8 sPauseDebug_Event34_Text[32] = SHIFT_JIS("KRAID BARISTUTES KILLED     ");
const u8 sPauseDebug_Event33_Text[32] = SHIFT_JIS("PLANT 90 DESTROYED          ");
const u8 sPauseDebug_Event32_Text[32] = SHIFT_JIS("PLANT 8F DESTROYED          ");
const u8 sPauseDebug_Event31_Text[32] = SHIFT_JIS("PLANT 8E DESTROYED          ");
const u8 sPauseDebug_Event30_Text[32] = SHIFT_JIS("PLANT 8D DESTROYED          ");
const u8 sPauseDebug_Event2F_Text[32] = SHIFT_JIS("PLANT 8C DESTROYED          ");
const u8 sPauseDebug_Event2E_Text[32] = SHIFT_JIS("ZIPLINES ACTIVATED          ");
const u8 sPauseDebug_Event2D_Text[32] = SHIFT_JIS("BUGS KILLED AFTER BOMBS     ");
const u8 sPauseDebug_Event2C_Text[32] = SHIFT_JIS("ALL 3 HIVES DESTROYED       ");
const u8 sPauseDebug_Event2B_Text[32] = SHIFT_JIS("DESSGEEGA KILLED            ");
const u8 sPauseDebug_Event2A_Text[32] = SHIFT_JIS("VISITED STATUE ROOM         ");
const u8 sPauseDebug_Event29_Text[32] = SHIFT_JIS("REPEL MACHINE KILLED        ");
const u8 sPauseDebug_Event28_Text[32] = SHIFT_JIS("CROCOMIRE KILLED            ");
const u8 sPauseDebug_Event27_Text[32] = SHIFT_JIS("MOTHER BRAIN KILLED         ");
const u8 sPauseDebug_Event26_Text[32] = SHIFT_JIS("RIDLEY ELEVATOR STATUE      ");
const u8 sPauseDebug_Event25_Text[32] = SHIFT_JIS("RIDLEY KILLED               ");
const u8 sPauseDebug_Event24_Text[32] = SHIFT_JIS("RIDLEY GADORA KILLED        ");
const u8 sPauseDebug_Event23_Text[32] = SHIFT_JIS("IMAGO KILLED                ");
const u8 sPauseDebug_Event22_Text[32] = SHIFT_JIS("COCOON KILLED               ");
const u8 sPauseDebug_Event21_Text[32] = SHIFT_JIS("IMAGO TUNNEL DISCOVERED     ");
const u8 sPauseDebug_Event20_Text[32] = SHIFT_JIS("CATERPILLAR KILLED          ");
const u8 sPauseDebug_Event1F_Text[32] = SHIFT_JIS("KRAID ELEVATOR STATUE       ");
const u8 sPauseDebug_Event1E_Text[32] = SHIFT_JIS("KRAID KILLED                ");
const u8 sPauseDebug_Event1D_Text[32] = SHIFT_JIS("KRAID GADORA KILLED         ");
const u8 sPauseDebug_Event1C_Text[32] = SHIFT_JIS("ACID WORM KILLED            ");
const u8 sPauseDebug_Event1B_Text[32] = SHIFT_JIS("DEOREM KILLED AT 2ND        ");
const u8 sPauseDebug_Event1A_Text[32] = SHIFT_JIS("DEOREM 2ND LOCATION         ");
const u8 sPauseDebug_Event19_Text[32] = SHIFT_JIS("DEOREM 1ST LOCATION         ");
const u8 sPauseDebug_Event18_Text[32] = SHIFT_JIS("PLASMA BEAM OBTAINED        ");
const u8 sPauseDebug_Event17_Text[32] = SHIFT_JIS("GRAVITY SUIT OBTAINED       ");
const u8 sPauseDebug_Event16_Text[32] = SHIFT_JIS("SPACE JUMP OBTAINED         ");
const u8 sPauseDebug_Event15_Text[32] = SHIFT_JIS("SCREW ATTACK OBTAINED       ");
const u8 sPauseDebug_Event14_Text[32] = SHIFT_JIS("CHARGE BEAM OBTAINED        ");
const u8 sPauseDebug_Event13_Text[32] = SHIFT_JIS("VARIA SUIT OBTAINED         ");
const u8 sPauseDebug_Event12_Text[32] = SHIFT_JIS("HI-JUMP OBTAINED            ");
const u8 sPauseDebug_Event11_Text[32] = SHIFT_JIS("CHOZO PILLAR EXTENDED       ");
const u8 sPauseDebug_Event10_Text[32] = SHIFT_JIS("POWER GRIP OBTAINED         ");
const u8 sPauseDebug_Event0F_Text[32] = SHIFT_JIS("CHOZO SCREW ATTACK HINT     ");
const u8 sPauseDebug_Event0E_Text[32] = SHIFT_JIS("CHOZO WAVE HINT             ");
const u8 sPauseDebug_Event0D_Text[32] = SHIFT_JIS("CHOZO VARIA SUIT HINT       ");
const u8 sPauseDebug_Event0C_Text[32] = SHIFT_JIS("CHOZO HI-JUMP HINT          ");
const u8 sPauseDebug_Event0B_Text[32] = SHIFT_JIS("CHOZO SPEED BOOSTER HINT    ");
const u8 sPauseDebug_Event0A_Text[32] = SHIFT_JIS("CHOZO ICE BEAM HINT         ");
const u8 sPauseDebug_Event09_Text[32] = SHIFT_JIS("CHOZO BOMBS HINT            ");
const u8 sPauseDebug_Event08_Text[32] = SHIFT_JIS("CHOZO LONG BEAM HINT        ");
const u8 sPauseDebug_Event07_Text[32] = SHIFT_JIS("ENTER TOURIAN DEMO          ");
const u8 sPauseDebug_Event06_Text[32] = SHIFT_JIS("ENTER MOTHER SHIP DEMO      ");
const u8 sPauseDebug_Event05_Text[32] = SHIFT_JIS("ENTER RIDLEY DEMO           ");
const u8 sPauseDebug_Event04_Text[32] = SHIFT_JIS("EXIT KRAID DEMO             ");
const u8 sPauseDebug_Event03_Text[32] = SHIFT_JIS("ENTER NORFAIR DEMO          ");
const u8 sPauseDebug_Event02_Text[32] = SHIFT_JIS("HARD MODE                   ");
const u8 sPauseDebug_Event01_Text[32] = SHIFT_JIS("EASY MODE                   ");
const u8 sPauseDebug_Event00_Text[29] = SHIFT_JIS("DUMMY EVENT                 ");
#else // !RANDOMIZER
