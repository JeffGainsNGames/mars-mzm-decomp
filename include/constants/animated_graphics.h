...
MAKE_ENUM(u8, AnimatedGfxId) {
    ...
    ANIMATED_GFX_ID_MAIN_MISSILES,
    ANIMATED_GFX_ID_MAIN_SUPER_MISSILES,
    ANIMATED_GFX_ID_MAIN_POWER_BOMBS,
    ...
    ANIMATED_GFX_ID_SPRING_BALL,
    ANIMATED_GFX_ID_WALL_JUMP,
    ANIMATED_GFX_ID_INF_BOMB_JUMP,
...
#ifdef RANDOMIZER
    #define ANIMATED_GFX_TANK_FRAME_DELAY (CONVERT_SECONDS(0.15f))
#else // !RANDOMIZER
