...
MAKE_ENUM(u8, MessageId) {
    ...
    MESSAGE_SPRING_BALL,
    MESSAGE_WALL_JUMP,
    MESSAGE_INF_BOMB_JUMP,
    MESSAGE_ZIPLINES,
    MESSAGE_INFANT_METROID,
    MESSAGE_ICE_TRAP,
    // Hints
    MESSAGE_LONG_BEAM_HINT,
    MESSAGE_ICE_BEAM_HINT,
    MESSAGE_WAVE_BEAM_HINT,
    MESSAGE_BOMBS_HINT,
    MESSAGE_SPEED_BOOSTER_HINT,
    MESSAGE_HI_JUMP_HINT,
    MESSAGE_SCREW_ATTACK_HINT,
    MESSAGE_VARIA_SUIT_HINT,
#endif // RANDOMIZER
